      ...
      <div className="home-section">
        ...
        <div className="home-options">
          ...
          <ExpansiveCard
            ...
            description="Gerencie submissões de trabalhos científicos"
          >
            <Card title="Submeter Trabalho" path="/submeterTrabalho" icon={<Plus size={32} />} />
            <Card title="Visualizar Trabalhos" path="/visualizarTrabalhos" icon={<Eye size={32} />} />
          </ExpansiveCard>
        </div>
      </div>
    </div>
